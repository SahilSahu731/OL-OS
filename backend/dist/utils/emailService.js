...
exports.generateMonthlyBackupReport = exports.generateWeeklyReport = exports.generateDailyReport = exports.generateDailyCheckIn = exports.generateDailyBrief = exports.sendEmail = void 0;
...
const generateDailyReport = (report) => {
    const metricRows = [
    ...
    `).join('');
    const missedList = report.missedHabits.slice(0, 6).map((habit) => `
