...
export default function DashboardLayout({
  ...
  // Wait for both hydration and boot check to prevent hydration mismatch and content flashes
  if (!isHydrated || !isBootCheckComplete) {
    return null;
  }

  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950 relative overflow-hidden">
      <BiosphereBackground />
      ...
      >
        <UserSidebar
          isCollapsed={false}
          toggleCollapse={() => setIsMobileOpen(false)}
        />
      </div>
